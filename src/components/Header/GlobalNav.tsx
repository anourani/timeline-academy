  ...
  return (
    <div className="bg-black">
      <div className="mx-auto px-8 py-2 flex justify-between items-center relative">
        {/* Left side - Menu button and inline title */}
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="bg-transparent text-white text-sm font-medium border border-transparent rounded px-2 py-1 hover:border-gray-700 focus:border-gray-600 focus:outline-none focus:ring-1 focus:ring-gray-600 transition-colors max-w-[240px]"
          />
        </div>

        {/* Center - Logo */}
        <div className="absolute left-1/2 -translate-x-1/2 text-white pointer-events-none">
