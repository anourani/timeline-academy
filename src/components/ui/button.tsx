  ...
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-md text-sm font-medium whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        "glass-sm":
          "backdrop-blur-[12px] bg-white/10 border border-white/[0.15] rounded-[10px] min-w-[80px] gap-1 px-[13px] py-[7px] shadow-[0px_8px_32px_0px_rgba(0,0,0,0.4),inset_0px_1px_0px_0px_rgba(255,255,255,0.1)] text-[#c9ced4] hover:bg-white/20 hover:border-transparent hover:text-[#dadee5] hover:cursor-pointer active:bg-[rgba(37,99,235,0.4)] active:border-transparent active:text-[#dadee5] data-[active=true]:bg-[rgba(37,99,235,0.4)] data-[active=true]:border-transparent data-[active=true]:text-[#dadee5]",
      },
      size: {
