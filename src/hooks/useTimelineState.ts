...
export function useTimelineState() {
  ...
  const { chapters, updateChapters, resetChapters } = useChapters()
  ...
  return {
    // State
    events, title, description, categories, chapters, scale, currentScale, verticalScale, currentVerticalScale, groupByCategory,
    // Event actions
